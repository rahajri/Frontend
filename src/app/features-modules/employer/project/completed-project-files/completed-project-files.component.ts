...
@Component({
  selector: 'app-completed-project-files',
  templateUrl: './completed-project-files.component.html',
  styleUrls: ['./completed-project-files.component.scss'],
})
export class CompletedProjectFilesComponent implements OnInit {
