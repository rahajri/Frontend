...
import { apiResultFormat, category } from 'src/app/core/models/models';
@Component({
...
export class CategoriesComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.loadCategoriesData().subscribe((res: apiResultFormat) => {
      this.totalData = res.totalData;
      res.data.map((res: category, index: number) => {
